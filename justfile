...
# Inputs
sources := "src/main.c src/tools.c src/color.c src/cli.c src/days/day1.c src/days/day2.c src/days/day3.c src/days/day4.c src/days/day5.c src/days/day6.c src/days/day7.c"
